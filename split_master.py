...
"""
Split
./CT-Liver-master/images/
  ├─images
  └─masks

to the following test, train and valid sub datasets 

./CT-Liver-ImageMask-Dataset-V1
├─test
│  ├─images
│  └─masks
├─train
...
if __name__ == "__main__":
  try:
    images_dir = "./CT-Liver-master/images/"
    masks_dir  = "./CT-Liver-master/masks/"
    output_dir = "./CT-Liver-ImageMaskDataset-V1/"
